                ...
                <tr>
                	<td class="text-center"><?php echo $i++;?></td>
		              ...
		              <?php }?>
                   	...
                   	<td class="text-center">
                   		<a href="add_user.php?user_id=<?php echo $users_row['id'];?>" data-toggle="tooltip" title="Edit" class="btn btn-primary btn_edit"><i class="fa fa-edit"></i></a>

                   		<a href="manage_users.php?user_id=<?php echo $users_row['id'];?>" data-toggle="tooltip" title="Delete !" class="btn btn-danger btn_delete" onclick="return confirm('Are you sure? You will not be able to recover this.')"><i class="fa fa-trash"></i></a>
                   	</td>
                </tr>
               <?php
					}
